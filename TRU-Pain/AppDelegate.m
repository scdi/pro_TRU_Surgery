...
//-(void) webData  {
 ...
 /*   NSString *username = [SAMKeychain passwordForService:@"comSicklesoftTRUSurgery" account:@"username"];
    //auth
    NSString *password = [SAMKeychain passwordForService:@"comSicklesoftTRUSurgery" account:username];
...
//    NSString *username = [SAMKeychain passwordForService:@"comSicklesoftTRUSurgery" account:@"username"];
//    username = [SAMKeychain passwordForService:@"comSicklesoftTRUSurgery" account:@"username"];
//    //auth
//    NSString *password = [SAMKeychain passwordForService:@"comSicklesoftTRUSurgery" account:username];
    NSString *username = @"trupain000@me.com";
    NSString *password = @"Trupain000";
