//
//  PainExperiencePostSurgery.swift
//  TRU-Surgery
//
//  Created by jonas002 on 10/1/17.
...
/**
 ...
 assessment.
 */
struct PainExperiencePostSurgery: Assessment {
    // MARK: Activity
    
    let activityType: ActivityType = .painExperienceSurgery
    ...
    func carePlanActivity() -> OCKCarePlanActivity {
        ...
        let title = NSLocalizedString("Surgery Pain", comment: "")
    ...
    func task() -> ORKTask {
        ...
        let scdPainQuestionStepTitle = "Are you experiencing surgical pain?"
        ...
        //i. RATE YOUR PAIN
        let avgPainQuestion = NSLocalizedString("Please rate your average surgical pain over the past 24 hours.", comment: "")
        ...
        let mostPainQuestion = NSLocalizedString("Please rate your most recent surgical pain over the past 24 hours.", comment: "")
        ...
        let scdPainStatusQuestionStepTitle = "Compare to what your surgical pain has been pain before, how has it been over the past 24 hours?"
        ...
        //PAIN RESOLUTION
        let symptomStatusQuestionStepTitle = "Compared to yesterday, is your surgical pain…"
        ...
        let scdPainDiffQuestionStepTitle = "Can you tell the difference between your surgical pain and that people experience every day pain?"
        ...
        let painTypeDiffTextChoices = [
            ORKTextChoice(text: "I had surgical pain", value: "SurgicalPain" as NSCoding & NSCopying & NSObjectProtocol),
            ORKTextChoice(text: "I had non surgical pain", value: "NonSurgicalPain" as NSCoding & NSCopying & NSObjectProtocol)
